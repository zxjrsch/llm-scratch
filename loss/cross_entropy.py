...
def cross_entropy_loss(llm_unembedding: Float[torch.Tensor, 'batch sequence vocab'], tokens: Float[torch.Tensor, 'batch sequence']):
    ...
    return token_level_loss.mean()  # average across batch and seqence
...
if __name__ == '__main__':
    ...
    loss = cross_entropy_loss(llm_unembedding, tokens)
    print(loss)
